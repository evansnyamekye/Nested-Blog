...
**[Portfolio Website]** This blog website was developed with HTML5, CSS3, PHP and Javascript. It gives the position of the portfolio holder, brief introduction, skills, experience, education, services, the portfolio holder's work, contact information, a link to download a CV, and Career Achievement.
...
- git clone https://github.com/evansnyamekye/Post-index.git
Example commands:
...
```sh
  git https://github.com/evansnyamekye/Post-index.git
```
